          ...
          check&&  data && data.map((item,key)=>{
                ...
                return(<>
                   <div valu={key} className="content">
                    <h1 className="h1"><span className="span"> Title:</span> {item.title} <span className="spn">Play</span>   <button onClick={()=>{Removesong(item.title,item.Name)}} className="b">Remove</button> </h1>
